...
export interface ApiEstablecimientoEstablecimiento
  ...
  attributes: {
    ...
    transportes: Attribute.Relation<
      'api::establecimiento.establecimiento',
      'manyToMany',
...
export interface ApiHoteleHotele extends Schema.CollectionType {
...
export interface ApiResturanteResturante extends Schema.CollectionType {
  collectionName: 'resturantes';
  info: {
    singularName: 'resturante';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::resturante.resturante': ApiResturanteResturante;
